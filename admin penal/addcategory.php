...
<ul class="nav">
    ...
    ?>
                    ...
                    <li>
                        <a href="#"  class="active-menu"><i class="fa fa-user "></i>Manage category<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                ...
                <form action="addcategoryprocess.php" method="post" enctype="multipart/form-data" id="demo-form" data-parsley-validate="">

                       <div class="form-group">
    <label for="exampleInputEmail1">category Name:</label>
    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter categoryname" name="category_name" required/>
  </div>
