...
$qry = "SELECT * FROM reg_tbl WHERE usertype='customer' AND isactive=0 OR isactive=1";
$rs = mysqli_query($conn,$qry);
//$qry5="SELECT * FROM time_sloat WHERE status='booking' AND t_id='".$uid."' ";
...
<ul class="nav">
    ...
    ?>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-user "></i>Manage customer <span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW CUSTOMER</h1>
                    </div>
                </div>
	...
	<?php
		if(mysqli_num_rows($rs)>0){
			...
			if($usertype=="customer")
			 ...
			 ?>
			<tr><td><?php echo $row['firstname']?> <?php echo $row['lastname']?></td>
