            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-6">
                     <div class="logo main">
                            <a href="forgetpassword.php"><img class="responsive" src="assets/img/finallogo.png" alt="Startkit"></a>
                        </div>
                       </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="appoinment-wrapper">
                       <form name="forgetpassword" action="security_question.php" method="post">
            EMAIL: <span class="input input--hantus">
                                <input class="input__field input__field--hantus" type="email" class="form-control" id="exampleInputPassword1"  placeholder="test@example.com" class="" name="txtforget_us" autofocus required />
