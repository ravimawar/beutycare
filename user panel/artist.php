...
session_start();
$qry = "SELECT * FROM reg_tbl WHERE usertype='artist' AND  isactive=1";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-6">
                     <div class="logo main">
                            <a href="artist.php"><img class="responsive" src="assets/img/finallogo.png" alt="Startkit"></a>
                        </div>
                       </div>
...
<div class="beautician-footer-text"><br>
                        ...
                        <div class="beautician-content">
                            <div class="inner-content">
                                ...
                                <a href="artisttimes.php?sid=<?php echo $row['id']?>" class="boxed-btn">ADD</a>
