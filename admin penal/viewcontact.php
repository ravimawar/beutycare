...
session_start();
$qry = "SELECT * FROM contact_tbl WHERE isactive=0 OR isactive=1";
    ...
    ?>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW CONTACT</h1>
	...
	<?php
		if(mysqli_num_rows($rs)>0){
			...
			<tr>
				...
				<td><a href="blockcontact.php?id=<?php echo $row['cn_id']?>">change</a></td>
				<td><a href="editcontact.php?id=<?php echo $row['cn_id']?>">edit</a></td>
				<td><a href="deletecontact.php?id=<?php echo $row['cn_id']?>">delete</a></td>
