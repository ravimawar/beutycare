            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-6">
                     <div class="logo main">
                            <a href="complain.php"><img class="responsive" src="assets/img/finallogo.png" alt="Startkit"></a>
                        </div>
                       </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="appoinment-wrapper">
                        <form action="complainprocess.php" mathod="get">
                           ...
                           MOBILE NO: <span class="input input--hantus">
                           	...
                           	COMPLAIN: <span class="input input--hantus textarea" >
