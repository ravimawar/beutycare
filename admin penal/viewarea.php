...
$qry = "SELECT * FROM area_tbl WHERE isactive!=2";
...
<ul class="nav">
    ...
    ?>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-user "></i>Manage area <span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW AREA</h1>
	...
	<?php
		if(mysqli_num_rows($rs)>0){
			...
			<tr>
				...
				<td><a href="statuschange.php?area_id=<?php echo $row['area_id']?>">change</a></td>
                <td><a href="edit-area.php?area_id=<?php echo $row['area_id']?>">Edit</a></td>    	              
			</tr>	
