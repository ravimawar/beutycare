...
session_start();
$qry = "SELECT * FROM reg_tbl WHERE usertype='artist' AND isactive=0 OR isactive=1";
    ...
    ?>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW ALL ARTIST</h1>
...
<td><?php echo $row['isactive']?></td>
				...
				<td><a href="blockartist.php?id=<?php echo $row['id']?>">change</a></td>
			<td><a href="edit-artist.php?id=<?php echo $row['id']?>">edit</a></td>
				<td><a href="deleteartist.php?id=<?php echo $row['id']?>">delete</a></td>
