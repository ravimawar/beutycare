...
<ul class="nav">
    ...
    ?>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">EDIT SUB-CATEGORY</h1>
   ...
   <table>
    ...
    <input type="text" class="form-control"  id="exampleInputEmail1" name="sc_name"  value=" <?php 
				$sc_id = $row['sc_id'];
    ...
    <input type="text" class="form-control" value="<?php echo $row['subcategory_name']?>" id="exampleInputEmail1" name="subcategory_name"/>
  </div>
		<label for="exampleInputEmail1">profile_pic:
</label>
    			<img src="<?php echo $row['profile_pic']?>" width="100" height="100">
			<input type="file" name="fileToUpload" value="<?php echo $row['profile_pic']?>"><br><br>
        	<div class="form-group">
    <label for="exampleInputEmail1">Price:</label>
    <input type="text" class="form-control" value="<?php echo $row['price']?>" id="exampleInputEmail1" name="txt_price"/>
  </div>
