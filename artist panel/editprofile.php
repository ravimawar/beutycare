...
<ul class="nav">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"  name="txt_skill" value="<?php echo $row['skill']?>"/>

  </div>
  
  <div class="form-group">
    <label for="exampleInputEmail1">discription</label>
    <input type="text" class="form-control"  name="txt_dis" value="<?php echo $row['discription']?>"/>
