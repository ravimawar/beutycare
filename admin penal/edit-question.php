...
<ul class="nav">
   ...
   <form action="updatequestion.php" method="GET">
   <table>
			<input type="hidden" name="sq_id" value="<?php echo $row['sq_id']?>">
 <label for="exampleInputEmail1">Area Name</label>
    <input type="text" class="form-control" name="question_name" value="<?php echo $row['sq']?>"/>
  <br>
