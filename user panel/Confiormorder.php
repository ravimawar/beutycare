...
$qry6 = "SELECT * FROM time_sloat where t_id=$tid ";
//echo $qry6 ;die;
$rs6=mysqli_query($conn,$qry6);
//echo $rs6;die;
$row6=mysqli_fetch_assoc($rs6);
//print_r($row6['time']);die;
//echo $qry6;die;

$qry7="SELECT * FROM order_tbl Where order_id=$orderid";
...
<body>
    ...
    <section id="breadcrumb-area">
     ...
     <h3 align="center">Take screen shot for your reference</h1><br><br>
	...
	<div class="sub-total">
     ...
     <td><b><?php echo $total?></b></td>
      ...
      <div class="cart-buttons col-md-6" >
             <a href="deletefromcart.php" class="boxed-btn">CheckOut</a>
                                 </div>
                   <!--   <div class="cart-buttons   col-md-6"  align="right" >
            <a href="Cancaleorder.php" class="boxed-btn" >Cancale Order</a>
