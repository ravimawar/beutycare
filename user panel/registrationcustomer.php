            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="appoinment-wrapper">
                        <form action="dbprossescustomer.php" mathod="get" id="demo-form" data-parsley-validate="">
                             FIRST NAME: <span class="input input--hantus">
                                <input class="input__field input__field--hantus" type="text" name="txt_fn" placeholder="first name" id="input-08" required/>
                            ...
                            EMAIL: <span class="input input--hantus">
                                <input class="input__field input__field--hantus" type="email" name="txt_email" placeholder="email" id="mc_email" required/>
