...
session_start();
$id = $_SESSION['id'];
$qry="SELECT * FROM reg_tbl WHERE usertype='customer' AND id='".$id."'";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-6">
                     ...
                     <div class="logo main">
                            <a href="viewprofile.php"><img class="responsive" src="assets/img/finallogo.png" alt="Startkit"></a>
                        </div>
                       </div>
...
<?php
	...
	?>
</table></div></div></div></section></li></li></ul></nav></div></div></div></div></div></li></li></ul></nav></div></div></div></div></div></section>
