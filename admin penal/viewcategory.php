    ...
    ?>
		...
		if(mysqli_num_rows($rs)>0){
			...
			<tr>
				...
				<td><a href="deletecategory.php?sc_id=<?php echo $row['sc_id']?>">delete</a></td>
				<td><a href="blockcategory.php?sc_id=<?php echo $row['sc_id']?>">change</a></td>
                <td><a href="edit-category.php?sc_id=<?php echo $row['sc_id']?>">Edit</a></td>    	              
