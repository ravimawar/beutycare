...
session_start();
$qry = "SELECT * FROM feedback_tbl WHERE isactive=0 OR isactive=1";
    ...
    ?>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW FEEDBACK</h1>
	...
	<?php
		if(mysqli_num_rows($rs)>0){
			...
			<tr>
				...
				<td><a href="blockfeedback.php?id=<?php echo $row['f_id']?>">change</a></td>
				<td><a href="editfeedback.php?id=<?php echo $row['f_id']?>">edit</a></td>
				<td><a href="deletefeedback.php?id=<?php echo $row['f_id']?>">delete</a></td>				
			</tr>	
