...
{
	header("location:registrationcustomer.php");
	exit();
}
...
if($pass!=$cpass)
{
	header("location:registrationcustomer.php?msg=wrong password.");
	exit();
}
...
$qry = "INSERT INTO reg_tbl(firstname,lastname,email,mobileno,gender,password,address,usertype,security_question1,security_answer1,security_question2,security_answer2,security_question3,security_answer3,isactive,doi) VALUES('".$fn."','".$ln."','".$email."','".$mobile."','".$gen."','".$pass."','".$address."','".$usertype."','".$sq1."','".$sa1."','".$sq2."','".$sa2."','".$sq3."','".$sa3."',$isactive,'".$dt."')";
//echo $qry;
//exit();
...
// $message = 'thaks for registration'; 
// $from = 'pareshbhaishivangi@gmail.com';
...
{
	echo "Insert Error!";
	header("location:registrationcustomer.php?msg:insert error!");
}
?>
