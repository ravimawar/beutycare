...
<ul class="nav">
   ...
   <table>
			<input type="hidden" name="id" value="<?php echo $row['cn_id']?>"><br><br>
			<label for="exampleInputEmail1">Name</label>
    <input type="text" class="form-control" name="txt_fn" value="<?php echo $row['name']?>"/>
  </div><br>
  ...
  <label for="exampleInputEmail1">Subject</label>
    <input type="text" class="form-control" name="txt_sub" value="<?php echo $row['subject']?>"/>
  </div><br>
