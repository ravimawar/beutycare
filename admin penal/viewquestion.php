...
$qry = "SELECT * FROM security_question_tbl WHERE isactive!=2";
    ...
    ?> </div>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW QUESTION</h1>
	...
	<?php
		if(mysqli_num_rows($rs)>0){
			...
			<tr>
				...
				<td><a href="deletequestion.php?sq_id=<?php echo $row['sq_id']?>">delete</a></td>
				<td><a href="blockquestion.php?sq_id=<?php echo $row['sq_id']?>">change</a></td>
                <td><a href="edit-question.php?sq_id=<?php echo $row['sq_id']?>">Edit</a></td>    	              
			</tr>	
