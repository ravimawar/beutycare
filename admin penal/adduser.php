...
<ul class="nav">
    ...
    ?>
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            ...
            <form action="dbprosses.php" method="get" id="demo-form" data-parsley-validate="">
   ...
   <div class="form-group">
                            ...
                            <td>
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-required="true" placeholder="Enter Answer" name="sa<?php echo $row1['sq_id']; ?>" required>      
                          </div>
                            </td>
                          </tr>
                          <?php }}?>  
